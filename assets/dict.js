...
function getJsonpCallback(dict) {
...
function loadContents() {
    ...
    for (var i = 0; i < Dictionaries.length; i++) {
        ...
        var jsonp = undefined;
        var jsonp_func = "jsonp = function(data){console.log(data); var dict = Dictionaries[" + i + "];  Dictionaries[" + i + "].func('jsonp', dict, data);}";
        eval(jsonp_func);
        ...
        try {
            ...
            Dictionaries[i].data = new Object();
            func("ready", Dictionaries[i], htmlNode);
        } catch(ex) {
